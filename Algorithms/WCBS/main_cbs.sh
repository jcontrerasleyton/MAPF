...
cust_func(){
  	echo "agents_file;w_limit;status;agents;cost;makespand;mov_cost;max_mov;high_exp;high_gen;low_exp;low_gen;iterations;cbs_time;total_time" >> ./Results/wcbs_$1-w_$2.csv
	...
	mv ./Results/wcbs_$1-w_$2.csv ./Results/$3/$4/$1/wcbs_$1-w_$2.csv
	#break
}

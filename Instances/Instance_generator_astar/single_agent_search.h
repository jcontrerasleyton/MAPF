...
class SingleAgentSearch {
 public:
  ...
  SingleAgentSearch(int start_location, int goal_location, const double* my_heuristic, const bool* my_map, int map_size,
  ...
  bool findPath(const vector < list< pair<int, int> > >* constraints, vector<int> left, int timestep, int type);
